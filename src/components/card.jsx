    ...
    return( 
        <>
            ...
            <div>
                ...
                <div>
                    <span className="text-rose-400"> {calculateRating(total, reviewsCount)} </span><span className="text-sm font-thasadith text-yellow-900 ms-1">{reviewsCount} reviews</span>
                </div>
                <div>
